...
const useStore = create((set, get) => ({
    ...
    storageSpaces: { '100材': { w: 1.1, h: 2.4, d: 1.1 }, /* ... */ },
    selectedSpace: '200材',
    itemsInScene: [],
...
// checkCollision 的完整內容
const checkCollision_full = (box1, box2) => {
    return box1.min.x < box2.max.x && box1.max.x > box2.min.x &&
        box1.min.y < box2.max.y && box1.max.y > box2.min.y &&
        box1.min.z < box2.max.z && box1.max.z > box2.min.z;
};
Object.assign(useStore.getState(), { checkCollision: checkCollision_full });

// getCalculations 的完整內容
useStore.setState({ getCalculations: () => { /* ... */ } });
